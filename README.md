...
Извлечение и кэширование векторов признаков [CLS] из всех изображений с использованием замороженного энкодера SIDA-7B. Результаты сохраняются на диск для повторного использования.
