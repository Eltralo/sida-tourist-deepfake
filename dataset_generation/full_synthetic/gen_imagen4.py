...
Модель  : Imagen 4  (Google DeepMind, каскадная латентная диффузия)
         
Домен   : Достопримечательности Москвы и Санкт-Петербурга, различные люди
Выход   : dataset/full_synthetic/imagen4/
Всего сгенерировано для датасета : 31 изображение

Important
─────────
Google DeepMind Imagen 4, каскадная архитектура латентной
диффузии с автоматическим встраиванием водяного знака SynthID.
Все изображения, сгенерированные этим скриптом, содержат невидимый водяной знак SynthID
в соответствии с политикой развёртывания Google DeepMind (arXiv:2510.09263).
